...
DeFi application (proof of concept) like Synthetix (WIP).
...
- [The Ultimate Guide To Synthetix](https://defitutorials.substack.com/p/the-ultimate-guide-to-synthetix)
